  ...
  return (
    <div className="max-w-sm bg-white rounded-lg   shadow-lg transition-all hover:scale-105">
      ...
      <div className="p-5">
        ...
        <a href="#contact" className="flex flex-row items-center rounded-tl-md w-fit md:text-xs text-xs  rounded-bl-xl rounded-br-md rounded-tr-xl  bg-gradient-to-r from-black to-[#E8375B] py-2 px-4 transition-all hover:scale-105">
